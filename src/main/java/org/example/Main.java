...
public class Main {
    public static void main(String[] args) {
        ...
        employees[2] = new Employee("Mukhamadeev Artur", "Developer", "sidorov@mailbox.com", "89231231214", 50000, 28);
        employees[3] = new Employee("Kozlov Nikolay", "Designer", "kozlov@mailbox.com", "89231231215", 35000, 40);
        employees[4] = new Employee("Sidorov Sergey", "Analyst", "smirnov@mailbox.com", "89231231216", 45000, 32);
